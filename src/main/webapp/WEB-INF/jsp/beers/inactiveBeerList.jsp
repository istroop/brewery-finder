...
<c:url var="formAction" value="/breweries/${breweryId}/reactivate"/>
<form method="POST" action="${formAction}" class="formPadding">
  <input type="hidden" name="CSRF_TOKEN" value="${CSRF_TOKEN}"/>
  <div class="page-container">
    <div class="page-container">
      <h1 style="text-align: center; font-family: 'Calistoga', cursive;"> Reactive Any Beers! </h1>
      <c:forEach var="beer" items="${beers}">
          <input type="Checkbox" name="${beer.name}" value="true"> ${beer.name}
      </c:forEach>
